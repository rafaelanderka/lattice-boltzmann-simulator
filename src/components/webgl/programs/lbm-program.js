...
class LBMProgram {
  ...
  _initFBOs() {
    ...
    // 0: fluid
    // 1: bounce-back
    this.nodeId = this.wgli.createFBO("RGBA", "NEAREST");
  ...
  _initFluid() {
    ...
    this.wgli.clear(this.velocity.read.fbo, this.params.initVelocity[0], this.params.initVelocity[1], 0.0);
    
    // Initialise fluid density
    this.wgli.clear(this.density.read.fbo, this.params.initDensity, 0.0, 0.0);
